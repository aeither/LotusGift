...
const BITTE_API_KEY = process.env.BITTE_API_KEY || process.env.BITTE_AI_SECRET_KEY;
function getBaseUrl() {
...
function buildManifest() {
    ...
    return {
        ...
        info: {
            ...
            description: 'A minimal agent exposing a coinflip and greeting tool. Extend with your own tools.',
            version: '0.1.0',
        },
        servers: [{ url: baseUrl }],
        paths: {
        ...
        'x-mb': {
            ...
            assistant: {
                ...
                description: 'A minimal agent with coinflip and greeting tools built with Hono.',
                instructions: 'Use coinflip for randomness; use greeting to greet users by name. Always be helpful and friendly.',
                tools: [
